...
Package.onUse(function (api) {
	...
	Npm.depends({
		i18next: 'git://github.com/benlavalley/i18next.git#master',
		'i18next-sprintf-postprocessor': 'git://github.com/benlavalley/i18next-sprintf-postProcessor.git#master',
	});
